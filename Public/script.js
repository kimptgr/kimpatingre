...
carouseltexte = ["<em>Je passe une grande partie de mon temps libre à créer : je couds, je tricote...</em>", "<em>J'aime beaucoup bouger. En ce moment, je fais de l'escalade en blocs & de la musculation à la maison.</em>", "<em>Membre du bureau de l'association Servon sur un plateau, je joue à des jeux de société mais aussi de rôle.</em>"];
